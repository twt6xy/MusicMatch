...
class Login extends Component {
  ...
  render() {
    const { email, password } = this.state
    return (
      <View style={{ flex: 1, backgroundColor: "#9DFEB7", paddingHorizontal: 30 }}>
        <View style={{ alignItems: 'center', marginTop: 60 }}>
          <Image source={require("../../assets/logo.png")} width={200} height={200} fill='#333' />
        </View>
        ...
        <View style={styles.button}>
          <Button onPress={this.handleOnLogin}>
            Login
          </Button>
        </View>
        <View
